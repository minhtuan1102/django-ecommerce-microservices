...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-chatbot-service-key-change-in-production')
...
# Microservices URLs
BEHAVIOR_SERVICE_URL = os.environ.get('BEHAVIOR_SERVICE_URL', 'http://behavior-analysis-service:8000')
...
CHROMA_PERSIST_DIRECTORY = os.environ.get('CHROMA_PERSIST_DIRECTORY', os.path.join(BASE_DIR, 'vectorstore'))
